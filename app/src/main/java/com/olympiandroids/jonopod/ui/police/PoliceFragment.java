package com.olympiandroids.jonopod.ui.police;
...
public class PoliceFragment extends Fragment implements ServiceProfileAdapterAll.ProfileClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Query query = profilesRef.whereEqualTo("sector","Police")
